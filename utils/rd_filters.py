...
def main():
    ...
    alert_file_name = cmd_input.get("--alerts") or pkg_resources.resource_filename('rd_filters',"rd_filters_data/alert_collection.csv")
    ...
    if cmd_input.get("template"):
        ...
        rules_file_name = cmd_input.get("--rules") or pkg_resources.resource_filename('rd_filters', "rd_filters_data/rules.json")
